 ...
 */ 
const APP_NAME = "tulustul-ants-sandbox"
const APP_PORT = "3000"
...
async function test(snapshot_name = "test", bug_name = "none", isDebugMode = false) {
    ...
    const options = {
        strCustomSelectionLogic: `(o.constructor.name == "Graphics2" || o.constructor.name === "Sprite2" && (o.parent === ${sampler.instanceName}._cor || Math.random() < 0.25))`,
    }
