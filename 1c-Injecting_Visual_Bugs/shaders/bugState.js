const vertexSourceBugState = `precision highp float;
#define SHADER_NAME pixi-shader-bug-state
...
const fragmentSourceBugState = `precision mediump float;
#define SHADER_NAME pixi-shader-bug-state
varying vec2 vTextureCoord;
varying vec4 vColor;
varying float vTextureId;
...
window.vertexSourceBugState = vertexSourceBugState;
window.fragmentSourceBugState = fragmentSourceBugState;
