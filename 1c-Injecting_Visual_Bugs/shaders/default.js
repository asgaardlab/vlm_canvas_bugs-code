const vertexSourceDefault = `precision highp float;
#define SHADER_NAME pixi-shader-default
...
const fragmentSourceDefault = `precision mediump float;
#define SHADER_NAME pixi-shader-default
varying vec2 vTextureCoord;
varying vec4 vColor;
varying float vTextureId;
...
window.vertexSourceDefault = vertexSourceDefault;
window.fragmentSourceDefault = fragmentSourceDefault;
