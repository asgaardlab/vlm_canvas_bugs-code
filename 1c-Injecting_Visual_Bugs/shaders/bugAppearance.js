const vertexSourceBugAppearance = `precision highp float;
#define SHADER_NAME pixi-shader-bug-appearance
...
const fragmentSourceBugAppearance = `precision mediump float;
#define SHADER_NAME pixi-shader-bug-appearance
varying vec2 vTextureCoord;
varying vec4 vColor;
varying float vTextureId;
...
window.vertexSourceBugAppearance = vertexSourceBugAppearance;
window.fragmentSourceBugAppearance = fragmentSourceBugAppearance;
